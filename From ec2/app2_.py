...
class TeamResource(Resource):
    ...
    def get(self, team_id):
        ...
        try:
            # fetch team
            team_resp = epl_table.get_item(Key={'TeamID': team_id})
            if 'Item' not in team_resp or team_resp['Item']['EntityType'] != 'Team':
            ...
            return {'team': team_resp['Item'], 'players': players}, 200
...
class EPLSearch(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return {'results': resp.get('Items', [])}, 200
        except ClientError as e:
            return {'error': e.response['Error']['Message']}, 500
