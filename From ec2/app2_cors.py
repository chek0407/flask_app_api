...
CORS(app, supports_credentials=True, origins=[
    "http://ec2-13-60-86-85.eu-north-1.compute.amazonaws.com:5000" # <-- The origin where your local http.server is running
    # Add other origins here when you deploy the frontend
])
